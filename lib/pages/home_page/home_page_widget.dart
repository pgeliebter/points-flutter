                    ...
                    child: StreamBuilder<List<AccountsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<AccountsRecord> listViewAccountsRecordList =
                            snapshot.data!;
                        if (listViewAccountsRecordList.isEmpty) {
                          return Image.asset(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            listViewAccountsRecord.nickname!,
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              valueOrDefault<String>(
                                                listViewAccountsRecord.company,
                                                'null',
                                              ),
                                              style:
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              'Expires - ${dateTimeFormat('yMd', listViewAccountsRecord.expiration)}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyText1
                                                      .override(
