...
import 'add_points_account_model.dart';
export 'add_points_account_model.dart';

class AddPointsAccountWidget extends StatefulWidget {
  const AddPointsAccountWidget({Key? key}) : super(key: key);

  @override
  _AddPointsAccountWidgetState createState() => _AddPointsAccountWidgetState();
}

class _AddPointsAccountWidgetState extends State<AddPointsAccountWidget> {
  late AddPointsAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPointsAccountModel());
